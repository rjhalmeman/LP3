...
public class GUIPessoa extends JDialog {
    ...
    public void zerarAtributos() {
        ...
        textFieldDataCadastroCliente.setText(cd.getDateParaStringBr(new Date()));
        textFieldRendaCliente.setText("");
        textFieldDataCadastroFuncionario.setText(cd.getDateParaStringBr(new Date()));
                    ...
                    try {
                        ...
                        if (pessoa != null) { //se encontrou
                            ...
                            if (cliente != null) { //é cliente
                                ...
                                textFieldRendaCliente.setText(String.valueOf(cliente.getRendaCliente().doubleValue()));
                            } else {
                                cbCliente.setSelected(false);
                                pnCliente.setVisible(false);
                            }
                            ...
                            if (funcionario != null) {
                                ...
                                textFieldDataCadastroFuncionario.setText(funcionario.getDataCadastro());
                                textFieldCargoFuncionario.setText(String.valueOf(funcionario.getCargoIdCargo().getIdCargo()
...
//                pessoa.setFuncionario(Funcionario.valueOf(textFieldFuncionario.getText()));
                if (!deuRuim) {
                    ...
                    if (cbCliente.isSelected()) {
                        ...
                        cliente.setDataCadastro(cd.getStringParaDataBr(textFieldDataCadastroCliente.getText()));
                    ...
                    if (cbFuncionario.isSelected()) {
                        ...
                        funcionario.setDataCadastro(cd.getStringParaDataBr(textFieldDataCadastroFuncionario.getText()));
                        funcionario.setCargoIdCargo(daoCargo.obter(Integer.valueOf(textFieldCargoFuncionario.getText().split("-")[0].trim())));
                        if (novo) {
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                    ...
                    Cliente cliente = new DAOCliente().obter(pessoa.getCpfPessoa());
                    if (cliente != null) {
                        new DAOCliente().remover(cliente);
                    }
                    Funcionario funcionario = new DAOFuncionario().obter(pessoa.getCpfPessoa());
                    if (funcionario != null) {
                        new DAOFuncionario().remover(funcionario);
                    }
