 ...
 * @author radames
 */
class PedidoGUIListar extends JDialog {

    Container cp;
    JPanel pnCentro = new JPanel();
    JPanel pnSul = new JPanel();
    
    JButton btSair = new JButton("Sair");String[] colunas = {"idPedido","data do pedido","Cliente"};String[][] dados = new String[0][colunas.length];
    DefaultTableModel model = new DefaultTableModel(dados, colunas);
    JTable tabela = new JTable(model);
    JScrollPane scrollTabela = new JScrollPane();
    private String idSelecionado;

    public PedidoGUIListar(DAOPedido daoPedido, Point coordenadas, Dimension dimensao) {
        ...
        List<Pedido> listaDados = daoPedido.listar();
