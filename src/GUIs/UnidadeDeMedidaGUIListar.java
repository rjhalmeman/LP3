 ...
 * @author radames
 */
class UnidadeDeMedidaGUIListar extends JDialog {
    ...
    String[] colunas = {"siglaUnidadeDeMedida", "nomeUnidadeDeMedida"};
    ...
    public UnidadeDeMedidaGUIListar(DAOUnidadeDeMedida daoUnidadeDeMedida, Point coordenadas, Dimension dimensao) {
        ...
        List<UnidadeDeMedida> listaDados = daoUnidadeDeMedida.listar();
//        for (UnidadeDeMedida listaDado : listaDados) {
