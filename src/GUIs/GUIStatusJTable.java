...
public class GUIStatusJTable extends JDialog {
...
//  ------------------------------------------------------------------------------------------------------ 
    ...
    public GUIStatusJTable(Point posicao, Dimension dimensao) {
...
//============================================ date editor =======================================================
    ...
    public static void main(String[] args) {
        new GUIStatusJTable(new Point(880, 250), new Dimension(800, 600));
    }
}
