...
public class GUIPessoaListagem extends JDialog {
    ...
    public GUIPessoaListagem(List<Pessoa> texto, int posX, int posY, Dimension dimensao) {
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getCpfPessoa()),
                String.valueOf(texto.get(i).getNomePessoa()),
                String.valueOf(texto.get(i).getFotoPessoa()),
                String.valueOf(texto.get(i).getEMailPessoa()),
                String.valueOf(texto.get(i).getCliente()),
                String.valueOf(texto.get(i).getFuncionario()),};
            model.addRow(linha);
        }
