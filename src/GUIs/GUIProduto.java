...
//Entidades para FK
    ...
    private void habilitarAtributos(boolean idProduto, boolean nomeProduto, boolean quantidadeEstoqueProduto, boolean precoProdutoCollection, boolean statusIdStatus, boolean unidadeDeMedidaIdUnidadeDeMedida, boolean pedidoHasProdutoCollection) {
        if (idProduto) {
