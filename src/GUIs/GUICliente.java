...
public class GUICliente extends JDialog {
    ...
    JTextField textFieldIdCliente = new JTextField(20);
    JLabel labelNomeCliente = new JLabel("NomeCliente");
    ...
    private void habilitarAtributos(boolean idCliente, boolean nomeCliente) {
        if (idCliente) {
...
//atritubos não chave, todos no painel centro
        ...
        usarGridBagLayout.add(labelNomeCliente, textFieldNomeCliente, corPadrao);
...
//-----------------------------  btnRetrieve ------------------------------------------
                ...
                if (textFieldIdCliente.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (cliente != null) { //se encontrou na lista
                            textFieldNomeCliente.setText(String.valueOf(cliente.getNomeCliente()));
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoCliente.autoIdCliente();
                textFieldIdCliente.setText(String.valueOf(prox));
                btnRetrieve.doClick();
                btnCreate.doClick();
            }
        });
...
//-----------------------------  SAVE ------------------------------------------
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                acao = "list";
                GUIClienteListagem guiClienteListagem = new GUIClienteListagem(daoCliente.listInOrderNome(), getBounds().x, getBounds().y, dimensao);
            }
        });
