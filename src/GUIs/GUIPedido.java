...
public class GUIPedido extends JDialog {
    ...
    JLabel labelPedidoHasProdutoCollection = new JLabel("PedidoHasProdutoCollection");
    JTextField textFieldPedidoHasProdutoCollection = new JTextField(20);
...
//Entidades para FK
    ...
    private void habilitarAtributos(boolean idPedido, boolean dataPedido, boolean clientePessoaCpfPessoa, boolean funcionarioPessoaCpfPessoa, boolean pedidoHasProdutoCollection) {
        ...
        textFieldPedidoHasProdutoCollection.setEditable(pedidoHasProdutoCollection);
    ...
    public void zerarAtributos() {
        ...
        textFieldPedidoHasProdutoCollection.setText("");
    }
...
//atritubos não chave, todos no painel centro
        ...
        usarGridBagLayout.add(labelPedidoHasProdutoCollection, textFieldPedidoHasProdutoCollection, corPadrao);
                ...
                if (textFieldIdPedido.getText().equals("")) {
                    ...
                    try {
                        ...
                        if (pedido != null) { //se encontrou na lista
                            ...
                            textFieldClientePessoaCpfPessoa.setText(String.valueOf(pedido.getClientePessoaCpfPessoa().getPessoaCpfPessoa() + "-" + pedido.getClientePessoaCpfPessoa().getDataCadastro()));
                            textFieldFuncionarioPessoaCpfPessoa.setText(String.valueOf(pedido.getFuncionarioPessoaCpfPessoa().getPessoaCpfPessoa() + "-" + pedido.getFuncionarioPessoaCpfPessoa().getDataCadastro()));
                            textFieldPedidoHasProdutoCollection.setText(String.valueOf(pedido.getClientePessoaCpfPessoa() + "-" + pedido.getFuncionarioPessoaCpfPessoa().getDataCadastro()));
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                pedido.setClientePessoaCpfPessoa(daoCliente.obter(String.valueOf(textFieldClientePessoaCpfPessoa.getText().split("-")[0])));
        ...
        textFieldPedidoHasProdutoCollection.addFocusListener(new FocusListener() { //ao receber o foco, fica verde
            @Override
            public void focusGained(FocusEvent fe) {
                textFieldPedidoHasProdutoCollection.setBackground(Color.GREEN);
            }

            @Override
            public void focusLost(FocusEvent fe) { //ao perder o foco, fica branco
                textFieldPedidoHasProdutoCollection.setBackground(corPadrao);
            }
        });
