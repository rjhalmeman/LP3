...
public class GUIStatus extends JDialog {
    ...
    JTextField textFieldIdStatus = new JTextField(20);
    JLabel labelNomeStatus = new JLabel("NomeStatus");
    JTextField textFieldNomeStatus = new JTextField(20);
...
//atritubos não chave, todos no painel centro
        ...
        usarGridBagLayout.add(labelNomeStatus, textFieldNomeStatus, corPadrao);
...
//-----------------------------  btnRetrieve ------------------------------------------
        ...
        btnNext.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                int prox = daoStatus.autoIdStatus();
                textFieldIdStatus.setText(String.valueOf(prox));
                btnRetrieve.doClick();
                btnCreate.doClick();
            }
        });
