...
public class GUIPedidoListagem extends JDialog {
    ...
    public GUIPedidoListagem(List<Pedido> texto, int posX, int posY, Dimension dimensao) {
        ...
        String[] colunas = new String[]{"idPedido",
            "dataPedido",
            "pedidoHasProdutoCollection",};
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdPedido()),
                sdf.format(texto.get(i).getDataPedido()),
                String.valueOf(texto.get(i).getPedidoHasProdutoCollection()),};
            model.addRow(linha);
        }
