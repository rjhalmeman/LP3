...
public class GUIPrecoProduto extends JDialog {
    ...
    DateTextField textFieldDataProduto = new DateTextField();
...
//Entidades para FK
    ...
    public GUIPrecoProduto(Point posicao, Dimension dimensao) {
        ...
        toolbar1.add(textFieldDataProduto);
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (textFieldIdProduto.getText().equals("")) {
                    ...
                    try {
                        ...
                        Date dt = cf.converteDeStringParaDate(textFieldDataProduto.getText());
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                precoProdutoPK.setProdutoIdProduto(Integer.valueOf(textFieldIdProduto.getText()));
                precoProdutoPK.setDataPrecoProduto(cf.converteDeStringParaDate(textFieldDataProduto.getText()));
