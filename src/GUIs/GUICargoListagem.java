...
// @author Radames
public class GUICargoListagem extends JDialog {
    ...
    public GUICargoListagem(List<Cargo> texto, int posX, int posY, Dimension dimensao) {
        ...
        String[] colunas = new String[]{"idCargo",
            "nomeCargo",};
        ...
        for (int i = 0; i < texto.size(); i++) {
            String[] linha = new String[]{String.valueOf(texto.get(i).getIdCargo()),
                String.valueOf(texto.get(i).getNomeCargo()),};
            model.addRow(linha);
        }
