...
public class GUIPrecoProdutoPK extends JDialog {
    ...
    public GUIPrecoProdutoPK(Point posicao, Dimension dimensao, int idProduto, Date data) {
...
//atritubos não chave, todos no painel centro
        ...
        textFieldProdutoIdProduto.setText(String.valueOf(idProduto));
        textFieldDataPrecoProduto.setText(sdf.format(data));
...
//                    daDoPrecoProdutoPK.remover(produto);
    ...
    public static void main(String[] args) {
        new GUIPrecoProdutoPK(new Point(880, 250), new Dimension(800, 600), 1, new Date());
    }
}
