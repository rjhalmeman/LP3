...
//        painelBotoes.add(btnRem);
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                tipoConta.setIdTipoConta(daoTipoConta.autoIdTipoConta());
                tipoConta.setNomeTipoConta("nova");
               
                try {
                    TipoConta c = daoTipoConta.obter(tipoConta.getIdTipoConta());
                    if (c == null) {
                        daoTipoConta.inserir(tipoConta);
        ...
        btnCarregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    List<TipoConta> lc = daoTipoConta.list();
