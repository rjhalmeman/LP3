...
public class UnidadeDeMedida {
    ...
    public UnidadeDeMedida(String siglaUnidadeDeMedida, String nomeUnidadeDeMedida) {
    ...
    public String toString() {
        return this.siglaUnidadeDeMedida + ";" + this.nomeUnidadeDeMedida;
    }
}
