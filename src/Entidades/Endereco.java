...
public class Endereco {
    ...
    public Endereco(int idEndereco, String logradouro, String numero, String referencia, String cep, int Cidade_idCidade) {
    ...
    public String toString() {
        return this.idEndereco + ";" + this.logradouro + ";" + this.numero + ";" + this.referencia + ";" + this.cep + ";" + this.Cidade_idCidade;
    }
}
