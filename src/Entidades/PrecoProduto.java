...
@NamedQueries({
    ...
    @NamedQuery(name = "PrecoProduto.findByProdutoIdProduto", query = "SELECT p FROM PrecoProduto p WHERE p.precoProdutoPK.produtoIdProduto = :produtoIdProduto"),
    @NamedQuery(name = "PrecoProduto.findByDataPrecoProduto", query = "SELECT p FROM PrecoProduto p WHERE p.precoProdutoPK.dataPrecoProduto = :dataPrecoProduto"),
    @NamedQuery(name = "PrecoProduto.findByPrecoProduto", query = "SELECT p FROM PrecoProduto p WHERE p.precoProduto = :precoProduto")})
