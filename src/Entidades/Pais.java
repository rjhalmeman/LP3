...
public class Pais {private int idPais;private String nomePais;private String siglaPais;
public Pais(){

}public Pais(int idPais,String nomePais,String siglaPais){this.idPais = idPais;this.nomePais = nomePais;this.siglaPais = siglaPais;}
...
}    public String toString() {return this.idPais+";"+this.nomePais+";"+this.siglaPais;}}